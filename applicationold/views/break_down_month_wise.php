                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-lg-6 mt-5" style="border:1px solid black;padding:15px">
                                    <div class="row">
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-8  text-center" id="">
                                            <div id="">
                                ...
                                <?php
                                $Electrical_check =  $this->Crud_model->query_sinegle("SELECT COUNT(id) AS SUM FROM breakdown_request WHERE type_of_breakdown = 'Electrical' AND  created_year = $year_id");
                                $Electrical = $Electrical_check[0]->SUM;

                                $Hydraulic_check =  $this->Crud_model->query_sinegle("SELECT COUNT(id) AS SUM FROM breakdown_request WHERE type_of_breakdown = 'Hydraulic' AND  created_year = $year_id");
                                $Hydraulic = $Hydraulic_check[0]->SUM;

                                $Mechanical_check =  $this->Crud_model->query_sinegle("SELECT COUNT(id) AS SUM FROM breakdown_request WHERE type_of_breakdown = 'Mechanical' AND  created_year = $year_id");
                                $Mechanical = $Mechanical_check[0]->SUM;

                                $Pneumatic_check =  $this->Crud_model->query_sinegle("SELECT COUNT(id) AS SUM FROM breakdown_request WHERE type_of_breakdown = 'Pneumatic' AND  created_year = $year_id");
                                $Pneumatic = $Pneumatic_check[0]->SUM;

                                $other_check =  $this->Crud_model->query_sinegle("SELECT COUNT(id) AS SUM FROM breakdown_request WHERE type_of_breakdown = 'Other' AND  created_year = $year_id");
