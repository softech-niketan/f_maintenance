                                        ...
                                        <tbody>
                                            ...
                                            if ($pending_request) {
                                                ...
                                                foreach ($pending_request as $p) {
                                                    ...
                                                    } else if ($p->type == "improvement") {
                                                        $status = "completed";
                                                        $br_request2 = $this->Crud_model->get_data_by_id("improvement_request", $p->pm_id, "id");
                                                        // echo   $p->pm_id;

                                                        $request_from = $this->Crud_model->get_data_by_id("user", $br_request2[0]->request_from, "id");
                                                        $request_to = $this->Crud_model->get_data_by_id("user", $br_request2[0]->request_to, "id");
                                                        $machines = $this->Crud_model->get_data_by_id("machines", $br_request2[0]->machine_id, "id");
                                                        $check_status = $br_request[0]->status;
                                                    } else {
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $machines[0]->id; ?></td>
                                                            <td><?php echo $machines[0]->asset_description; ?></td>

                                                            <td><?php if (!empty($request_to)) {
                                                                    echo $request_to[0]->user_name;
                                                                } else {
                                                                    echo "breakdown";
                                                                } ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a class="btn btn-primary" href="<?php echo base_url('spare_parts/') . $p->pm_id . '/improvement'; ?>">
                                                                        <i class="fas fa-cogs"></i>
                                                                    </a>
                                                                <?php
                                                                }else {
