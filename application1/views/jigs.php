                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Jigs and Fixtures</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo base_url('add_jigs') ?>" method="post">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Operation Name<span class="text-danger">*</span>
                                                                    <input required type="text" name="operationame" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Operation name">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            foreach ($jigs_list as $j) {
                                                $op = $this->Crud_model->days_count($j->InspectionDate);
                                            ?>
                                                <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><?php echo $j->AssetNumber ?></td>
                                                    <td> <?php echo $j->AssetDescription ?></td>
                                                    <td> <?php echo $j->OperationName ?></td>
                                                    ...
                                                    <td> <?php echo $j->CustomerName ?></td>
                                                    <td> <?php echo $j->Frequency ?></td>
                                                    <td> <?php echo $j->InspectionDate ?></td>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?php echo base_url('add_part') ?>" method="post" enctype='multipart/form-data'>
                                                                            ...
                                                                            <div class="text-center">
                                                                                ...
                                                                                <input type="hidden" name="table_name" value="jigs">
                                                        ...
                                                        <div class="modal fade" id="exampleModal1<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?php echo base_url('update_jigs') ?>" method="post">
                                                                            <div class="row">
                                                                                <div class="col-lg-4">
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Asset Number<span class="text-danger">*</span>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Operation Name<span class="text-danger">*</span>
                                                                                            <input required type="text" name="operationame" value="<?php echo $j->OperationName ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Operation name">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Location<span class="text-danger">*</span>
                                                                                            <input required type="text" value="<?php echo $j->Location ?>" class="form-control" name="location" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Location">
                                                                                ...
                                                                                <div class="col-lg-4">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Inspection Date<span class="text-danger">*</span>
                                                                                            <input required type="text" class="form-control" value="<?php echo $j->InspectionDate ?>" name="inspectiondate" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter PM Date">

                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="exampleInputEmail1">Customer Name<span class="text-danger">*</span>
                                                                                            <input required type="text" class="form-control" value="<?php echo $j->CustomerName ?>" name="customername" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Remark">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="<?php echo base_url('delete') ?>" method="POST">
                                                                            ...
                                                                            <input value="jigs" name="table_name" type="hidden" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Machine Name">
