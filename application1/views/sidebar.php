        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('user_role') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User Roles</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('instruments') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Instruments & Gauges</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('relation') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Relation Gauges</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('jigs') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Jigs & Fixtures</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('dies') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dies and Core Boxes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('utilitymachinespares') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Machine</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('software') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Software</p>
                </a>
              </li>
