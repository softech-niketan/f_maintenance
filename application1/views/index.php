        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-lg-2 text-center">
              ...
              <h5 style="margin-left:-50px">Test</h5>
            ...
            <div class="col-lg-2">
              <div id="chart_div3" style="width: 500px; height: 120px;"></div>


            </div>
            <div class="col-lg-2">
              <div id="chart_div4" style="width: 500px; height: 120px;"></div>


            </div>
            <div class="col-lg-2">
              <div id="chart_div5" style="width: 500px; height: 120px;"></div>



            </div>
            <div class="col-lg-2">
              <div id="chart_div6" style="width: 500px; height: 120px;"></div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div style="border:1px solid #111;" class="col-lg-4 border-1">
                  ...
                  <table id="" class=" table table table-striped">
                    <thead>
                      <tr>
                        <th>Sr No.</th>
