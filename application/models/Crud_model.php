...
class Crud_model extends CI_Model
{
	...
	public  function get_all_row($table_name)
	{
		
		//$this->db->where('company_id', $search);
    ...
    {
		$this->db->where('status !=', 'FeedBack');

      //  $this->db->where('status !=', 'request_closed');
        $this->db->from($type);
        return $this->db->count_all_results();
    }
	public function count_type_pending($type)
    {
    ...
    public function get_data_paged($type, $limit, $offset)
    {
		//$this->db->where('status !=', 'checksheet_completed');
	...
	public function get_data_paged_pending($type, $limit, $offset)
    {
		//$this->db->where('status !=', 'checksheet_completed');
	...
	public function count_type3($type)
    {
		//$this->db->where('status !=', 'FeedBack');
    ...
    public function get_data_paged3($type, $limit, $offset)
    {
		//$this->db->where('status !=', 'FeedBack');
	...
	public function count_type4($type)
    {
		$this->db->where('status =', 'request_closed');
    ...
    public function get_data_paged4($type, $limit, $offset)
    {
	...
	public function get_data_paged412_search($type)
	{
	...
	public function get_data_paged411_search($type)
	{
	...
	public function get_data_paged4_search($type, $search)
{
	...
	public function count_type1($type)
    {
		//$this->db->where('status !=', 'FeedBack');
    ...
    public function get_data_paged1($type, $limit, $offset)
    {
		//$this->db->where('status !=', 'FeedBack');
	...
	public function count_type2($type)
    {
		//$this->db->where('status !=', 'FeedBack');
    ...
    public function get_data_paged2($type, $limit, $offset)
    {
		//$this->db->where('status !=', 'FeedBack');
	...
	public function get_data_by_id_search($table_name, $search)
	{
			$this->db->order_by("id", "desc");
			$this->db->like('asset_number', $search);
			$this->db->or_like('code', $search);
			$this->db->or_like('asset_description', $search);
	...
	public function get_data_by_id_search1($table_name, $search)
	{
		
			$this->db->or_like('feedback', $search);
	...
	public function get_data_by_id12($table_name, $name)
	{
		
		$this->db->order_by("id", "desc");

		if ($query = $this->db->get_where($table_name, $name)->result()) {
			return $query;
		} else {
			return false;
		}
	...
	public function get_data_by_id_multile12($table_name, $array)
	{
