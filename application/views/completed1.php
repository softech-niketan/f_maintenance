...
<form action="<?php  echo base_url('completed/' . $type) ?>" method="POST">
...
<a class="btn btn-info btn-sm" href="<?php  echo base_url('completed/' . $type) . $this->session->userdata('seg11');?>">Reset</a>  &nbsp;


<input type="text" placeholder="Search.." name="search">


<button href="<?php echo base_url('completed/') . $type . '/' . $p->id; ?>" type="submit"><i class="fa fa-search"></i></button>
</form>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-1">
                    <ol class="breadcrumb float-sm-right">
                    <!-- <li class="breadcrumb-item"><?php// echo $pagination_links ?></li> -->

                        <!-- <?php//  if ($search == null ){ ?> -->
                        <li class="breadcrumb-item"><?php echo $pagination_links ?></li>
                       <!-- <?php//   }else{?> -->
                                            <?php ?>
                        <!-- <li class="breadcrumb-item"><?php//  echo $pagination_links_search ?></li> -->
                        <!-- <?php//  }?> -->
                    </ol>
                </div>
            </div>
