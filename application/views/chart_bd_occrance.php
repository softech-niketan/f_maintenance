                                        ...
                                        <tr>
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    ...
                                                    <input type="hidden" value="1" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        JAN
                                                    </button>
                                                </form>
                                            </th>
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="2" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        FEB
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="4" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        MAR
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="5" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        MAY
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="6" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        JUN
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="7" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        JUL
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="8" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        AUG
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="9" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        SEP
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="10" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        OCT
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="11" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        NOV
                                                    </button>
                                                </form>
                                            ...
                                            <th>
                                                <form action="<?php echo base_url('break_down_day_wise'); ?>" method="POST">
                                                    <input type="hidden" value="<?php echo $year_id; ?>" name="year_id">
                                                    <input type="hidden" value="12" name="month_id">
                                                    <button type="submit" type="submit" class="btn btn-default">
                                                        DEC
                                                    </button>
                                                </form>
