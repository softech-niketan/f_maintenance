...
// }
?>
<form class="example" action="<?php echo base_url('pending/'). $type; ?>" method="post">
  <input type="text" placeholder="Search.." name="search">
  <button type="submit"><i class="fa fa-search"></i></button>
</form>
<!-- <form id="searchForm" class="example" action="<?php echo base_url('pending/') . $type; ?>" method="post">
  <input type="text" id="searchInput" placeholder="Search.." name="search">
  <button type="submit"><i class="fa fa-search"></i></button>
</form>
<?php //print_r($pageee);die(); ?>
<script>
  document.getElementById('searchForm').addEventListener('submit', function(event) {
    event.preventDefault(); // Prevent the default form submission
    var searchInput = document.getElementById('searchInput').value; // Get the search input value
    var baseUrl = "<?php echo base_url('pending/') . $type . '/' . $pageee; ?>"; // Get the base URL from PHP
    var newUrl = baseUrl + '?search=' + encodeURIComponent(searchInput); // Construct the new URL with query parameter
    window.location.href = newUrl; // Redirect to the new URL
                                                ...
                                                <!-- <a class="btn btn-primary"
                                                    href="<?php echo base_url('history/') . $type . '/' . $p->id; ?>">
                                                    History</a> -->
                    ...
                    if ($status != "Postpone") {
                        if ($status != "Accept") {
                            if ($user_role == "machine_shop_maintenance_admin" || $user_role == "admin" || $user_role == "maintenance_user") {
                                ...
                                ?>
                                                <a class="btn btn-primary"
                                                    href="<?php echo base_url('view_checkshit/') . $p->pm_group_id . '/' . $p->id ?>">
...
if ($user_role == "machine_shop_maintenance_admin" || $user_role == "admin" || $user_role == "maintenance_user") {
                ...
                ?>
                                                <a class="btn btn-primary"
                                                    href="<?php echo base_url('spare_parts/') . $p->id . '/' . $type; ?>">
...
// }
            ?>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#staticBackdrop<?php echo $i; ?>">
                                                    Change Status
                                                </button>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <form
                                                                            action="<?php echo base_url('create_history') ?>"
                                                                            method="POST" enctype="multipart/form-data">
                                                                            <label for="">Current Status <span
                ...
                if ($user_role == "machine_shop_production_admin" || $user_role == "admin") {
                    ?>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <label for="">Select Status <span
                                                                                class="text-danger">*</span></label>
                                                                        <select required name="status"
                                                                            id="hi<?php echo $i; ?>"
                                                                            onchange="myFunction(this,<?php echo $i; ?>)"
                                                                    ...
                                                                    <div class="col-lg-12" style="display: none;"
                                                                        id="new_trigger<?php echo $i; ?>">
                                                                        <div class="row">

                                                                            <div class="col-lg-12">
                                                                                <label for="">New PM Date <span
                                                                                        class="text-danger">*</span></label>
                                                                                <input type="date" class="form-control"
                                                                                    name="new_pm_date">
                                                                            </div>
                                                                            <div class="col-lg-12">
                                                                                <label for="">New PM Time <span
                                                                                        class="text-danger">*</span></label>
                                                                    ...
                                                                    function myFunction(selectObject, id) {
                                                                        ...
                                                                        if (value === "Postpone") {
                                                                            // alert(valuediv)
                                                                            document.getElementById(valuediv).style
                                                                                .display = 'block'; // Hide
                    ...
                    ?>
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <select required name="status"
                                                                            ...
                                                                            onchange="myFunction(this,<?php echo $i; ?>)"
                                                                            class="form-control" id="">
                                                                            <option value="Request_Closed">Request
                                                                                Closed</option>
                                                                        </select>
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <label for="">Enter Feedback <span
                                                                                class="text-danger">*</span></label>
                                                                        <input required type="text"
                                                                            placeholder="Enter Your Feedback"
                                                                            class="form-control" name="feedback" id="">
                ...
                ?>
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <h6 class="text-danger">Please Fill All
                                                                            Checkshit <?php echo $p->id ?> , To Complete
                                                                            This Request </h6>
            ...
            if ($type == "pm_request") {
                ?>
                                                                <input type="hidden" name="pm_group_id"
                                                                    value="<?php echo $p->pm_group_id ?>" id="">
            ...
            ?>
                                                                <input type="hidden" name="pm_id"
                                                                    value="<?php echo $p->id ?>" id="">
                                                                <input type="hidden" name="machine_id"
                                                                    value="<?php echo $p->machine_id ?>" id="">
                                                                <input type="hidden" name="table_name"
                                                                    value="<?php echo $table_name ?>" id="">
                                                                <input type="hidden" name="new_pm_date_2"
                                                                    value="<?php echo $pm_date ?>" id="">
                                                                <input type="hidden" name="new_pm_time_2"
                                                                    value="<?php echo $pm_time ?>" id="">
                                                                <?php
