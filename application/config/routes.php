...
$route['chart_mttr'] = 'ReportsController/chart_mttr';
$route['chart_mtbf'] = 'ReportsController/chart_mtbf';
$route['chart_bd_occrance'] = 'ReportsController/chart_bd_occrance';
$route['chart_bd_hourse'] = 'ReportsController/chart_bd_hourse';
$route['chart_bd_cost'] = 'ReportsController/chart_bd_cost';
$route['chart_pm_cost'] = 'ReportsController/chart_pm_cost';
$route['chart_improvement_cost'] = 'ReportsController/chart_improvement_cost';
$route['why_why'] = 'ReportsController/why_why';
$route['why_why_view'] = 'ReportsController/why_why_view';
...
$route['pending/(:any)/(:any)'] = 'AdminController/pending';

$route['completed/(:any)'] = 'AdminController/completed';
$route['completed/(:any)/(:any)'] = 'AdminController/completed';

$route['breakdown_pending'] = 'AdminController/breakdown_pending';
$route['breakdown_pending/(:any)'] = 'AdminController/breakdown_pending';

$route['breakdown_complete'] = 'AdminController/breakdown_complete';
$route['breakdown_complete/(:any)'] = 'AdminController/breakdown_complete';

$route['i_work_request_pending'] = 'AdminController/i_work_request_pending';
$route['i_work_request_pending/(:any)'] = 'AdminController/i_work_request_pending';
...
$route['update_breadkdown_details_team'] = 'AdminController/update_breadkdown_details_team';
