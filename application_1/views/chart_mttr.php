    ...
    $jan1 = $this->db->query('SELECT SUM(id) as SUM1  FROM breakdown_request   WHERE crated_month = 1 AND created_year =  ' . $year_id . ' ')->result();
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>MEAN TIME TO REPAIR ( MTTR).<?php echo $dec ?> </h1>
                        </div>
                        <div class="col-sm-6">
