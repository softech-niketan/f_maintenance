    ...
    <div class="content-wrapper" >
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Instruments and Gauges History</h1>
                    </div>
                    <div class="col-sm-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($history_instruments as $p)
                                            {
                                                ...
                                                <td><?php if(empty($p->old_calibration_date)){echo "NA";}else{echo $p->old_calibration_date;}?></td>
                                                <td><?php if(empty($p->old_calibration_due_date)){echo "NA";}else{echo $p->old_calibration_due_date;}?></td>
                                                <!-- <td><?php echo $p->old_calibration_due_date;?></td> -->
                                                <td><?php echo $p->created_date;?></td>
                                                <td class="<?php echo $p->overdue_bg;?>"><?php echo $p->overdue;?></td>
                                                <td>
